...
import com.ttyd.videoplayer.videolib.listener.GSYMediaPlayerListener;
import com.ttyd.videoplayer.videolib.listener.VideoAllCallBack;
import com.ttyd.videoplayer.videolib.utils.CommonUtil;
import com.ttyd.videoplayer.videolib.utils.Debuger;
import com.ttyd.videoplayer.videolib.utils.NetInfoModule;
import java.io.File;
import java.util.HashMap;
import java.util.Map;

import static com.ttyd.videoplayer.videolib.utils.CommonUtil.getTextSpeed;
...
public abstract class GSYVideoView extends GSYTextureRenderView implements GSYMediaPlayerListener {
    ...
    protected void init(Context context) {
        ...
        mScreenWidth = getActivityContext()
            .getResources()
            .getDisplayMetrics().widthPixels;
        mScreenHeight = getActivityContext()
            .getResources()
            .getDisplayMetrics().heightPixels;
        mAudioManager = (AudioManager) getActivityContext()
    ...
    protected void createNetWorkState() {
        if (mNetInfoModule == null) {
            mNetInfoModule = new NetInfoModule(getActivityContext().getApplicationContext(),
