package com.ttyd.videoplayer.videolib.video.base;
...
import com.ttyd.videoplayer.videolib.R;
import com.ttyd.videoplayer.videolib.utils.CommonUtil;
import com.ttyd.videoplayer.videolib.utils.Debuger;
import com.ttyd.videoplayer.videolib.utils.OrientationUtils;
import com.ttyd.videoplayer.videolib.view.SmallVideoTouch;
import java.lang.reflect.Constructor;

import static com.ttyd.videoplayer.videolib.utils.CommonUtil.getActionBarHeight;
import static com.ttyd.videoplayer.videolib.utils.CommonUtil.getStatusBarHeight;
import static com.ttyd.videoplayer.videolib.utils.CommonUtil.hideNavKey;
import static com.ttyd.videoplayer.videolib.utils.CommonUtil.hideSupportActionBar;
import static com.ttyd.videoplayer.videolib.utils.CommonUtil.showNavKey;
import static com.ttyd.videoplayer.videolib.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
        ...
        if (isShowFullAnimation()) {
            postDelayed(new Runnable() {
                @Override public void run() {
                    Debuger.printfLog("GSYVideoBase resolveFullVideoShow isVerticalFullByVideoSize "
                        + isVertical);
    ...
    @SuppressWarnings("ResourceType, unchecked") public GSYBaseVideoPlayer startWindowFullscreen(
        ...
        try {
            ...
            final FrameLayout.LayoutParams lpParent = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    @SuppressWarnings("ResourceType, unchecked") public GSYBaseVideoPlayer showSmallVideo(
        ...
        try {
            ...
            FrameLayout.LayoutParams lpParent = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT);
